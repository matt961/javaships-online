...
public final class JavashipsProtocol {
	...
	public static final String GAMEOVER = "gg";
	...
	/**
	 * The player that loses sends this message to their opponent.
	 *
	 * @param sender
	 */
	public static void sendGameOver(PrintWriter sender) {
		sender.println(GAMEOVER);
	}

	/**
	 * The player will tell the other player that they have placed all of their ships.
	 *
	 * @param sender
	 */
	public static void sendReady(PrintWriter sender) {
	 ...
	 */
	public static void sendMessage(PrintWriter sender, final String chatMessage) throws
																				 IOException,
																				 BadMessageException {
		if (sender == null) {
