...
public class JavashipsClient {
	...
	//@TODO: Find out why this thing can't receive the sent message...
	private void networkListener() {
		while (true) {
			try {
				if (hasConnection) {
					String[] received = commandReader.readLine().split(".");
					System.out.println(received[0] + received[1]);
					switch (received[0]) {
						case MESSAGE:
							ChatArea.append(received[1] + "\n");
							break;
						case QUIT:
							quitGame();
					}
